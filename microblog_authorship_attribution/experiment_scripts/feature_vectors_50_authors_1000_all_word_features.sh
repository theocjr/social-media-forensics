...
RUN_ID="${ROOT_DIR}/experiments/feature_vectors_${MINIMAL_NUMBER_TWEETS}_${VALIDATION_FOLDING}_${REPETITIONS}_${NUM_AUTHORS}_${TWEETS_PER_USER}_all_word_features_${DATE}"
