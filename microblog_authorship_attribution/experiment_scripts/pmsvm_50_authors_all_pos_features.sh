...
FEATURES="pos-1-gram pos-2-gram pos-3-gram pos-4-gram pos-5-gram"

for TWEETS_PER_USER in $TWEETS_PER_USER_LIST;
do
    echo " $TWEETS_PER_USER of $TWEETS_PER_USER_LIST"
    RUN_ID="pmsvm_classifier_${MINIMAL_NUMBER_TWEETS}_${VALIDATION_FOLDING}_${REPETITIONS}_${NUM_AUTHORS}_${TWEETS_PER_USER}_all_pos_features_${DATE}"
