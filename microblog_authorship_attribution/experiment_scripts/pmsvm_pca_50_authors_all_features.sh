...
do
    ...
    RUN_ID="pmsvm_pca_classifier_${MINIMAL_NUMBER_TWEETS}_${VALIDATION_FOLDING}_${REPETITIONS}_${NUM_AUTHORS}_${TWEETS_PER_USER}_${FEATURES}_${PCA_VARIANCE}_${DATE}"
    /work/atheophilo/microblog_authorship_attribution/code/classification/pmsvm_pca_classifier.py \
