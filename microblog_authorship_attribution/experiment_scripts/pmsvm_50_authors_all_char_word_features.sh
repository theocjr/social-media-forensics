...
FEATURES="char-4-gram word-1-gram word-2-gram word-3-gram word-4-gram word-5-gram"

for TWEETS_PER_USER in $TWEETS_PER_USER_LIST;
do
    echo " $TWEETS_PER_USER of $TWEETS_PER_USER_LIST"
    RUN_ID="pmsvm_classifier_${MINIMAL_NUMBER_TWEETS}_${VALIDATION_FOLDING}_${REPETITIONS}_${NUM_AUTHORS}_${TWEETS_PER_USER}_all_char_word_features_${DATE}"
    /work/atheophilo/microblog_authorship_attribution/code/classification/pmsvm_classifier.py \
