...
SOURCE_DIR="${ROOT_DIR}/experiments/pmsvm_classifier_1000_10_10_50_1000_all_201605061305"
RUN_ID="${ROOT_DIR}/experiments/rf_classifier_fest_1000_10_10_50_1000_all_${NUMBER_TREES}_${DATE}"
