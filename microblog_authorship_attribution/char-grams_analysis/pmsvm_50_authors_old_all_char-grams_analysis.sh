...
REPETITIONS="10"
FEATURES="char-4-gram word-1-gram word-2-gram word-3-gram word-4-gram word-5-gram pos-1-gram pos-2-gram pos-3-gram pos-4-gram pos-5-gram"

echo "Running ... "
RUN_ID="pmsvm_classifier_char-grams_analysis_${VALIDATION_FOLDING}_${REPETITIONS}_old_all_${DATE}"
