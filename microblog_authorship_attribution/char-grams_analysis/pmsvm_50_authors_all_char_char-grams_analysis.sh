...
REPETITIONS="10"
FEATURES="char-1-gram char-2-gram char-3-gram char-4-gram char-5-gram"

echo "Running ... "
RUN_ID="pmsvm_classifier_char-grams_analysis_${VALIDATION_FOLDING}_${REPETITIONS}_all_char_${DATE}"
