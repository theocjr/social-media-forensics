...
* `feature_vectors_generator.py`: Code to read n-grams data and to output feature vectors in libsvm format. Its input are the n-grams output by `ngrams_generator.py` code. This code is used to prepare the data for the `rf_classifier_fest.py` code.
